...
RUN apt-get update && apt-get install -y php5-common php5-cli php5-fpm php5-mcrypt php5-imap php5-mysqlnd php5-apcu php5-gd php5-imagick php5-curl php5-intl php5-xsl php-pear wkhtmltopdf
